...
class WebhookController {
    ...
    @PostMapping("/payment")
    fun handlePaymentWebhook(@RequestBody payload: Map<String, Any>): Mono<ResponseEntity<ApiResponse<String>>> {
    ...
    fun handleSubscriptionWebhook(@RequestBody payload: Map<String, Any>): Mono<ResponseEntity<ApiResponse<String>>> {
        return Mono.fromCallable {
            val eventType = payload["type"] as? String ?: "unknown"
    ...
    private fun handlePaymentCompleted(paymentId: String, payload: Map<String, Any>) {
    ...
    private fun handlePaymentFailed(paymentId: String, payload: Map<String, Any>) {
    ...
    private fun handlePaymentRefunded(paymentId: String, payload: Map<String, Any>) {
    ...
    private fun handleSubscriptionCreated(subscriptionId: String, payload: Map<String, Any>) {
        // Create new subscription record
        // Send welcome email
        println("Subscription created: $subscriptionId")
    }

    private fun handleSubscriptionUpdated(subscriptionId: String, payload: Map<String, Any>) {
        // Update subscription details
        // Send update notification
        println("Subscription updated: $subscriptionId")
    }

    private fun handleSubscriptionCancelled(subscriptionId: String, payload: Map<String, Any>) {
        // Cancel subscription
