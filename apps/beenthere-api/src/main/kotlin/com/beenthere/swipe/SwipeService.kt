...
class SwipeService(
    ...
    private fun checkForMatch(targetType: String, targetId: String): Mono<String?> {
    ...
    fun getTargetSwipes(targetType: String, targetId: String): Flux<SwipeEntity> {
        return r2dbcEntityTemplate.select(SwipeEntity::class.java)
    ...
    fun hasUserSwipedOnTarget(userId: String, targetType: String, targetId: String): Mono<Boolean> {
        return r2dbcEntityTemplate.select(SwipeEntity::class.java)
            .matching(Query.query(
